...
public final class Exam05 implements Exam {
    ...
    /**
     * Notepad - это внутренний приватный класс реализующий логику блокнота
     */
    ...
    private final class Notepad {
        ...
        /**
         * Data - внутренний приватный класс является пользовательским типом данных для хранения записей
         */
